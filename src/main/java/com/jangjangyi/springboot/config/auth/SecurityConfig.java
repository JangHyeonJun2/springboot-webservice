...
import com.jangjangyi.springboot.domain.user.Role;
 ...
 *
 * 9. userService
 * - 소셜 로그인 성공 시 후속 조치를 진행할 UserService 인터페이스의 구현체를 등록 합니다.
